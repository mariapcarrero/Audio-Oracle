...
vector<vector<double>> GenerateAudioFramesGist(string input_filename, int start_frame, int hop_size)
{
...
int main()
{
    ...
    vector<vector<double>> audioFrame = GenerateAudioFramesGist("/Users/mariapaulacarrero/Documents/GitHub/Audio-Oracle/driverslicense.wav",0,8192);
    ...
    gist.processAudioFrame(audioFrame[0]);
    ...
    float spectralFlatness = gist.spectralFlatness();
    cout << "spectralFlatness: " << spectralFlatness << endl;
    gist.processAudioFrame(audioFrame[1]);
    float spectralFlatness2 = gist.spectralFlatness();
    float specCent2 = gist.spectralCentroid();
    cout << "spectralFlatness2: " << spectralFlatness2 << endl;
    cout << "spectralCentroid2: " << specCent2 << endl;

    AudioOracleGist audio_oracle;
    //audio_oracle.AnalyseAudio("/Users/mariapaulacarrero/Documents/GitHub/Audio-Oracle/driverslicense.wav",8192, "centroid");
