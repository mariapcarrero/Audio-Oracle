...
int main()
{
    ...
    audio_oracle.AnalyseAudio("/Users/mariapaulacarrero/Documents/GitHub/Audio-Oracle/thespectre.wav",4096);
    vector<int> vector_final;
    //vector_final = audio_oracle.AOGenerate(0,200,0.7,0);
    /*for(int i = 0; i < 200; i++)
        cout << vector_final[i] << " ";
    cout << endl*/;
    audio_oracle.GenerateAudio(1000,400,0.7,0,4096,8192,"/Users/mariapaulacarrero/Documents/GitHub/Audio-Oracle/thespectre.wav","/Users/mariapaulacarrero/Documents/GitHub/Audio-Oracle/thespectreOut.wav");
