...
int phi, k, fo_iter;
void FactorOracle::AddState(int first_state){
    this->states_[first_state].state_ = first_state;
}

void FactorOracle::AddTransition(int first_state, int last_state, char symbol) {
...
string FactorOracle::FOGenerate( int& i, string v, float q)
{
...
int FactorOracle::FindBetter(int i, char alpha, string word)
{
...
int FactorOracle::LengthCommonSuffix( int phi_one, int phi_two)
{
...
void FactorOracle::AddLetter(int i, string word)
{
...
void FactorOracle::FactorOracleStart(string word)
{
...
void FactorOracle::CallGenerate(int len, int q)
{
    string oracle = "";
    fo_iter = 1;
   // int q = 0;
